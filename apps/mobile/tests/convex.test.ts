...
import betterAuthSchema, * as betterAuthSchemaModule from '../../../packages/backend/convex/betterAuth/schema';
...
import schema, * as schemaModule from '../../../packages/backend/convex/schema';
